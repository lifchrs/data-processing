...
def process_video(video_dir, annotation_path, original_annotation_path,
    ...
    for depth_path in depth_files:
        ...
        def _reproject_to_pi3(pts_cam, ann_intrinsics):
            """Reproject points from annotation camera space to Pi3 camera space.

            Annotation and Pi3 may have different intrinsics/resolutions.
            Project to 2D with annotation intrinsics, scale to Pi3 resolution,
            unproject with Pi3 intrinsics. Preserves correct 2D position.
            """
...
def main():
    ...
    for i, entry in enumerate(manifest):
        ...
        # Use corrected annotation if available
